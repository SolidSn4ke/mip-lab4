...
var $author$project$Main$Model = F5(
	function (objFile, sceneFile, alertText, alertVisibility, imageReady) {
		return {alertText: alertText, alertVisibility: alertVisibility, imageReady: imageReady, objFile: objFile, sceneFile: sceneFile};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A5($author$project$Main$Model, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, '', $rundis$elm_bootstrap$Bootstrap$Alert$closed, false),
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$renderPpm = _Platform_outgoingPort('renderPpm', $elm$json$Json$Encode$string);
var $author$project$Main$RecieveResponse = function (a) {
	return {$: 'RecieveResponse', a: a};
};
...
var $author$project$Main$sendForm = F2(
	function (objFile, sceneFile) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$multipartBody(
					_List_fromArray(
						[
							A2($elm$http$Http$filePart, 'obj', objFile),
							A2($elm$http$Http$filePart, 'scene', sceneFile)
						])),
				expect: $elm$http$Http$expectString($author$project$Main$RecieveResponse),
				...
				return _Utils_Tuple2(
					...
					function (_v1) {
						...
						if ((_v2.a.$ === 'Just') && (_v2.b.$ === 'Just')) {
							var obj = _v2.a.a;
							var scene = _v2.b.a;
							return A2($author$project$Main$sendForm, obj, scene);
						} else {
							return $elm$core$Platform$Cmd$none;
						}
					}(
						_Utils_Tuple2(model.objFile, model.sceneFile)));
			case 'UpdateObj':
				var f = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							objFile: $elm$core$Maybe$Just(f)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateSceneFile':
				var f = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							sceneFile: $elm$core$Maybe$Just(f)
						}),
					$elm$core$Platform$Cmd$none);
			case 'RecieveResponse':
				var res = msg.a;
				if (res.$ === 'Ok') {
					var s = res.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{alertText: 'Scene rendered successfully!', alertVisibility: $rundis$elm_bootstrap$Bootstrap$Alert$shown, imageReady: true}),
						$author$project$Main$renderPpm(s));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{alertText: 'Error', alertVisibility: $rundis$elm_bootstrap$Bootstrap$Alert$shown}),
						$elm$core$Platform$Cmd$none);
				}
			default:
...
var $author$project$Main$SendForm = {$: 'SendForm'};
var $author$project$Main$UpdateObj = function (a) {
	return {$: 'UpdateObj', a: a};
};
var $author$project$Main$UpdateSceneFile = function (a) {
	return {$: 'UpdateSceneFile', a: a};
};
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('obj-input')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('OBJ Файл')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('obj-input'),
										$elm$html$Html$Attributes$type_('file'),
										A2(
										$elm$html$Html$Events$on,
										'change',
										A2($elm$json$Json$Decode$map, $author$project$Main$UpdateObj, $author$project$Main$fileDecoder))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('scene-input')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Параметры сцены')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('scene-input'),
										$elm$html$Html$Attributes$type_('file'),
										A2(
										$elm$html$Html$Events$on,
										'change',
										A2($elm$json$Json$Decode$map, $author$project$Main$UpdateSceneFile, $author$project$Main$fileDecoder))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$SendForm)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('render-canvas'),
